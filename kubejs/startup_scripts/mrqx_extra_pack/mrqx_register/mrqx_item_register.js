...
StartupEvents.registry('item', event => {
    ...
    {// 骑士系列
        ...
        registerOrgan(new Organ('mrqx_extra_pack:knight_armor_piece')
            ...
            .addTextLines('alt', [LEADING_SYMBOL, Text.gray({ "translate": "mrqx_extra_pack.tooltips.knight_armor_piece.3" })])
            .addScore('health', 0.25)
            .addScore('nerves', 0.25)
            .addScore('breath_recovery', 0.25)
            .addScore('strength', 1.25)
        ...
        registerOrgan(new Organ('mrqx_extra_pack:knight_chain_hammer')
            ...
            .addTextLines('ctrl', [LEADING_SYMBOL, Text.gray({ "translate": "mrqx_extra_pack.tooltips.knight_chain_hammer.2" })])
            .addScore('nerves', 3)
            .addScore('strength', 3)
            .build())
