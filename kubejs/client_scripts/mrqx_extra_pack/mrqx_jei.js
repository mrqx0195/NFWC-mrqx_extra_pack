...
JEIEvents.information(event => {
    ...
    $MysteriousItemConversionCategory.RECIPES.add($ConversionRecipe.create(Item.of('gateways:gate_pearl', '{gateway: "mrqx_extra_pack:shadow_of_caerula_arbor"}'), 'mrqx_extra_pack:heart_tidal_elegy'))
    $MysteriousItemConversionCategory.RECIPES.add($ConversionRecipe.create(Item.of('gateways:gate_pearl', '{gateway: "mrqx_extra_pack:shadow_of_caerula_arbor"}'), 'mrqx_extra_pack:lung_the_tide_surges_the_tide_recedes'))
    $MysteriousItemConversionCategory.RECIPES.add($ConversionRecipe.create(Item.of('gateways:gate_pearl', '{gateway: "mrqx_extra_pack:shadow_of_caerula_arbor"}'), 'mrqx_extra_pack:kidney_moon_in_the_water'))
    $MysteriousItemConversionCategory.RECIPES.add($ConversionRecipe.create(Item.of('gateways:gate_pearl', '{gateway: "mrqx_extra_pack:shadow_of_caerula_arbor"}'), 'mrqx_extra_pack:liver_tide_observation'))
    $MysteriousItemConversionCategory.RECIPES.add($ConversionRecipe.create(Item.of('gateways:gate_pearl', '{gateway: "mrqx_extra_pack:shadow_of_caerula_arbor"}'), 'mrqx_extra_pack:pancreas_group_hunting'))
    $MysteriousItemConversionCategory.RECIPES.add($ConversionRecipe.create(Item.of('gateways:gate_pearl', '{gateway: "mrqx_extra_pack:shadow_of_caerula_arbor"}'), 'mrqx_extra_pack:muscle_bone_fracture'))
    $MysteriousItemConversionCategory.RECIPES.add($ConversionRecipe.create(Item.of('gateways:gate_pearl', '{gateway: "mrqx_extra_pack:shadow_of_caerula_arbor"}'), 'mrqx_extra_pack:rib_the_pressure_to_survive'))
    $MysteriousItemConversionCategory.RECIPES.add($ConversionRecipe.create(Item.of('gateways:gate_pearl', '{gateway: "mrqx_extra_pack:shadow_of_caerula_arbor"}'), 'mrqx_extra_pack:stomach_abyssal_predator'))
    $MysteriousItemConversionCategory.RECIPES.add($ConversionRecipe.create(Item.of('gateways:gate_pearl', '{gateway: "mrqx_extra_pack:shadow_of_caerula_arbor"}'), 'mrqx_extra_pack:spine_abyssal_intuition'))
    $MysteriousItemConversionCategory.RECIPES.add($ConversionRecipe.create(Item.of('gateways:gate_pearl', '{gateway: "mrqx_extra_pack:shadow_of_caerula_arbor"}'), 'mrqx_extra_pack:intestine_survival_of_the_fittest'))
    $MysteriousItemConversionCategory.RECIPES.add($ConversionRecipe.create(Item.of('gateways:gate_pearl', '{gateway: "mrqx_extra_pack:shadow_of_caerula_arbor"}'), 'mrqx_extra_pack:appendix_assimilation_mutation'))
    $MysteriousItemConversionCategory.RECIPES.add($ConversionRecipe.create(Item.of('gateways:gate_pearl', '{gateway: "mrqx_extra_pack:mechanical_frenzy"}'), 'mrqx_extra_pack:seance_cpu'))
    $MysteriousItemConversionCategory.RECIPES.add($ConversionRecipe.create(Item.of('gateways:gate_pearl', '{gateway: "mrqx_extra_pack:god_judgement"}'), 'mrqx_extra_pack:sin_and_judgement'))
