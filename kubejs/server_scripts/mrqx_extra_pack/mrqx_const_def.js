...
const mrqxAdvancementsCheck = {
    'mystery_flesh_and_blood': ['biomancy:biomancy/bio_forge', 'biomancy:biomancy/bio_injector', 'biomancy:biomancy/bio_lab', 'biomancy:biomancy/cat_killer', 'biomancy:biomancy/cooked_meat_sacrifice', 'biomancy:biomancy/cradle', 'biomancy:biomancy/decomposer', 'biomancy:biomancy/digester', 'biomancy:biomancy/exotic_compounds', 'biomancy:biomancy/flesh', 'biomancy:biomancy/genetic_compounds', 'biomancy:biomancy/greedy_butcher', 'biomancy:biomancy/healing_activator_sacrifice', 'biomancy:biomancy/organ_trader', 'biomancy:biomancy/organic_compounds', 'biomancy:biomancy/poacher', 'biomancy:biomancy/predator_killer', 'biomancy:biomancy/raw_meat_sacrifice', 'biomancy:biomancy/root'],
    ...
    'mystery_disasters': ["cataclysm:find_ancient_factory", "cataclysm:find_burning_arena", "cataclysm:find_cursed_pyramid", "cataclysm:find_ruined_citadel", "cataclysm:find_soul_black_smith", "cataclysm:find_sunken_city", "cataclysm:kill_ender_golem", "cataclysm:kill_ender_guardian", "cataclysm:kill_harbinger", "cataclysm:kill_ignis", "cataclysm:kill_leviathan", "cataclysm:kill_monstrosity", "cataclysm:kill_remnant", "cataclysm:kill_revenant", "cataclysm:root", "witherstormmod:main/belly_of_the_beast", "witherstormmod:main/cured_sickened_mob", "witherstormmod:main/escape_wither_storm", "witherstormmod:main/fbomb", "witherstormmod:main/harbinger_of_cataclysmic_fates", "witherstormmod:main/infinite_potential", "witherstormmod:main/insane_dedication", "witherstormmod:main/root", "witherstormmod:main/silver_lining", "witherstormmod:main/spyglass_at_wither_storm", "witherstormmod:main/strong_grow_weak", "witherstormmod:main/summon_wither_storm", "witherstormmod:main/weakened_arise_stronger", "witherstormmod:main/wither_storm_defeated"],
